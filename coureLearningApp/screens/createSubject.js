...
// export default function createPage(navigation) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Text style={[styles.header, {fontFamily: "Krub_400Regular"}]}>Create My Subject</Text>
      ...
      <Button title="+" color="#937DC2" onPress={pickImage} style={{margin: 20}}/>
        <Text style={[styles.description, {fontFamily: "Krub_400Regular"}]}>อัพโหลดรูปหน้าปก</Text>
        {imageShow && <Image style={[styles.logo, {fontFamily: "Krub_400Regular"}]} source={{ uri: imageShow}}/>}
        
        {/* <Button title="upload" color="#937DC2" onPress={uploadImage}/> */}
      </View>
      <View style={[styles.buttonCreate, {fontFamily: "Krub_400Regular"}]}>
