...
const chapterList = ({ route, navigation }) => {
    ...
    docsSubject[0].chapter.forEach((doc) => {
        itemSubject.push(<TouchableOpacity style={styles.button} onPress={() => {
            ...
            <Image style={{ width: '100%', height: "60%", marginBottom: 5, backgroundColor: "white", borderTopLeftRadius: 20, borderTopRightRadius: 20 }} source={require("../assets/Dayflow Buy Online.png")}></Image>
            <View style={[{ margin: 10 }]}>
                <Text style={[{ fontSize: 40, fontWeight: 'bold', color: "#3E00CD", fontFamily: "Krub_400Regular"}]}>Chapter {doc.idChapter}</Text>
                <Text style={[{ fontSize: 15, fontWeight: 'bold', color: "#3E00CD", fontFamily: "Krub_400Regular" }]}>{doc.nameChapter}</Text>
            </View>
        </TouchableOpacity>
        )
    })
        ...
        <LinearGradient
            ...
            <View style={styles.navTextimg}>
                ...
                <View style={styles.col}>
                    <Text style={[styles.headerWelcome1, {fontFamily: "Krub_400Regular"}]}>Let's Learn</Text>
                    <Text style={[styles.headerWelcome2, {fontFamily: "Krub_400Regular"}]} numberOfLines={3}>{docsSubject[0].nameSubject}</Text>
                    <Text style={[styles.headerWelcome3, {fontFamily: "Krub_400Regular"}]} numberOfLines={3}>
            ...
            <View style={styles.buttonCreate}>
                {role == "student" ?
                    <></>
                    :
                    <Button style={{fontFamily: "Krub_400Regular"}} title="Create Chapter"
                        color="#937DC2"
                        onPress={() => {
